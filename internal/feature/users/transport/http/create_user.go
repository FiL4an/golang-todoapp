...
type CreateUserRequest struct {
	...
	PhoneNumber *string `json:"phone_number" validate:"omitempty,min=10,max=15,startswith=+" example:"+79998887777"`
}
...
func domainFromDTO(dto CreateUserRequest) domain.Users {
	return domain.NewUserUnItialazed(dto.FullName, dto.PhoneNumber)
}
