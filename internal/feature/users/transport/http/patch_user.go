...
import (
	...
	core_http_utils "github.com/FiL4an/golang-todoapp/internal/core/transport/http/utils"
)
...
func userPatchFromRequest(request PacthUserRequest) domain.UserPatch {
	return domain.UserPatch{
		FullName:    request.FullName.ToDoamin(),
		PhoneNumber: request.PhoneNumber.ToDoamin(),
	}
}
